export default {
    ...
    servicesPage: {
        ...
        items: [
            {
                id: 'builds',
                title: 'Construcció & Personalitzacions a Mida',
                subtitle: 'Somnis convertits en fusta i corda.',
            ...
            {
                id: 'electronics',
                title: 'Electrònica & Bruxeria',
                subtitle: "Dominant l'art de la soldadura.",
                desc: "Cablejat personalitzat, canvi de pastilles, divisió de bobines, interruptors de tall, interruptors de fase i solució per a aquell brunzit misteriós que et torna boig. Utilitzo potenciòmetres, condensadors i interruptors d'alta qualitat per garantir una ruta de senyal pura.",
            },
        ],
    },
